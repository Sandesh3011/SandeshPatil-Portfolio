    ...
    <>
      <section className="section background" id="B">
        ...
        <div className="section_content">
          ...
          <p>
            I am a 2025 graduate with a Bachelor's degree (B.Tech) in
            ...
            , affiliated with
            <span>
              <a class="study-link" href="https://dbatu.ac.in/" target="_blank">
          ...
          <p>
            ...
            needs and also committed to helping people realize their vision.
          </p>
          ...
          >
            ...
            <div className="status_message">
              Interested in working together? Check out my resume and let's connect!
    ...
    <>
      <section className="section skills" id="s">
        ...
        <div className="section_content">
          <div className="skills_type">
            <div className="skills_category">
              <div
                className="skills_category_lable"
              ...
              <ul className="skills_category_item">
            ...
            <div className="skills_category">
              ...
              <ul className="skills_category_list">
                ...
                <li className="skills_category_item">Bootstrap</li>
                <li className="skills_category_item">jQuery</li>
                <li className="skills_category_item">API Integration</li>
              </ul>
              {/* <ul className="skills_category_item">Spring Boot</ul>
		 ...
		 */}
            ...
            <div className="skills_category">
              <div className="skills_category_lable">Tools</div>
              ...
              <ul className="skills_category_item">Postman / API Testing</ul>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="section_content">
          <div className="project">
            <figure className="project_pic">
              <a
                href="https://portfolio-generator-41a5a.firebaseapp.com/"
                target="_blank"
              >
                {/* <img src="./images/lets_code.png" alt="image" /> */}
                <video
                  ref={(el) => (videoRefs.current[0] = el)}
                  src="/images/PortfolioGenerator.mp4"
                  autoplay
                  loop
                  muted
                  playsInline
          ...
          <details open>
            ...
            <div className="featured-projects-content">
              <p>
                "Developed a React.js web app that generates personalized
                portfolios based on user input. Integrated Firebase to store
                user data, assign unique IDs, and provide shareable portfolio
                URLs."
              </p>
            </div>
        ...
        <div class="section_content">
          <div className="project">
            <figure className="project_pic">
              ...
              <a
                href="https://sandesh3011.github.io/Snake-Game-Project/"
                target="_blank"
              >
                {/* <img src="./images/lets_code.png" alt="image" /> */}
                <video
                  ref={(el) => (videoRefs.current[1] = el)}
                  src="/images/snakeGameVid.mp4"
                  autoplay
                  loop
                  muted
                  playsInline
          ...
          <details open>
            ...
            <div className="featured-projects-content">
              <p>
                "Developed a responsive Snake Game using HTML, CSS, and
                JavaScript. The project features smooth animations, score
                tracking, and optimized performance for an engaging user
          ...
          <div className="project">
            <figure className="project_pic">
              <a
                href="https://github.com/Sandesh3011/Virtual-Document-Locked"
                target="_blank"
              >
                <video
                  ref={(el) => (videoRefs.current[2] = el)}
                  src="/images/vdocs.mp4"
                  autoplay
                  loop
                  muted
                  playsInline
          ...
          <details open>
            ...
            <div class="project">
              <br />
              <p>
                "Developed a web application for uploading and managing secure
                and unsecured PDF files. Users can set profile-specific
                passwords during registration to protect access to secure files,
                which are only viewable, downloadable, or deletable with this
                password. Unsecured files can be accessed freely. Additionally,
                users can change both account and profile passwords for enhanced
                security control."
              </p>
              <div class="project_used">
                ...
                <span class="project_used_item">
                  Java (backend connectivity)
                </span>
    ...
    <>
      <footer className="footer">
        ...
        <div className="footer_links">
          ...
          <a
            href="https://www.linkedin.com/in/sandesh-patil-83691a294/"
            target="_blank"
            title="linkedin"
          >
            {/* <span className="text">
          ...
          <a
            href="https://github.com/Sandesh3011"
            target="_blank"
            title="GitHub"
          >
            {/* <span className="text">
        ...
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          >
            <ul className="font-medium text-lg flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
              ...
              <li>
                <a
                  href="mailto:sandeshp9011@gmail.com"
                  className="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent"
                >
                  Contact
                </a>
              ...
              <li>
                <div className="switch-wrapper flex items-center ">
                  ...
                  <div className="toggle-wrapper">
                    ...
                    />
                    <label htmlFor="switch" id="switch1">
                      Toggle
                    </label>
                  </div>
